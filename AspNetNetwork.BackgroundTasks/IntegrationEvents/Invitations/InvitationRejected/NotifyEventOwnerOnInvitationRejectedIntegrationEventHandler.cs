...
using AspNetNetwork.Events.Invitation.Events.InvitationRejected;

namespace AspNetNetwork.BackgroundTasks.IntegrationEvents.Invitations.InvitationRejected
{
    /// <summary>
